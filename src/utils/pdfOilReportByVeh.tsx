...
const generatePDFOilReportByVeh = (
  arr: IOil[],
  fileName: string,
  ...
  doc.setFontSize(20);
  doc.text("Oil report for a vehicle", 105, 40);
  doc.setFontSize(12);
  doc.text("กลุ่มยานยนต์ :", 35, 50);
  doc.text(fleetName ? fleetName : "Error", 70, 50);
  doc.text("ทะเบียน :", 35, 55);
  doc.text(registration ? registration : "Error", 70, 55);
...
export { generatePDFOilReportByVeh };
